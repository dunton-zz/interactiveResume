...
var HTMLcontactGeneric = '<li class="flex-item"><span class="orange-text">%contact%</span></li>';
...
var HTMLskillsStart = '<h3 id="skills-h3"><span class="white-text">Skills at a Glance:</span></h3><ul id="skills" class="flex-column"></ul>';
var HTMLskills = '<li class="flex-item"><span class="white-text">%data%</span></li>';

var HTMLworkStart = '<div class="work-entry"></div>';
var HTMLworkEmployer = '<a href="#"><span class="text-left">%data%</span></a>';
...
var HTMLworkDescription = '<p><br><span class="text-left">%data%</span></p>';
